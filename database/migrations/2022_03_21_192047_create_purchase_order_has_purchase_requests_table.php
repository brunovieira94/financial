...
class CreatePurchaseOrderHasPurchaseRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_has_purchase_requests', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('purchase_order_has_purchase_requests');
    }
}
