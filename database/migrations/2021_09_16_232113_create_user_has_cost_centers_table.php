...
class CreateUserHasCostCentersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_has_cost_centers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_has_cost_centers');
    }
}
