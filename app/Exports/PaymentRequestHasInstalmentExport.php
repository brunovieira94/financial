...
class PaymentRequestHasInstalmentExport implements FromCollection, ShouldAutoSize, WithMapping, WithHeadings, WithEvents
{
    private $fileName;
    ...
    {
        return $this->paymentRequestInstallmentClean->get();
    }
