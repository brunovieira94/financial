...
class StoreProviderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'responsible' => 'max:250',
            'provider_categories_id' => 'required|integer|exists:provider_categories,id',
            ...
            'full_name' => 'required_if:provider_type,==,F|string|max:255|prohibited_if:provider_type,==,J|nullable',
