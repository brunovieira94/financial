...
class RouteApprovedPaymentRequest extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'provider' => new ReportsProviderAllResource($this->provider),
            ...
            'installments' => ReportsInstallmentsAllResource::collection($this->installments),
        ];
    }
}
