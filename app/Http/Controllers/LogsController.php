...
class LogsController extends Controller
{
    ...
    public function getBillingLogs(Request $request, $id)
    {
    ...
    public function getLogHotelUpdate(Request $request, $id)
    {
        return $this->logsService->getLogHotelUpdate($id, $request->all());
    }
