...
class PaymentRequestService
{
    ...
    private $with = ['purchase_order.purchase_order','purchase_order.purchase_order_installments', 'company', 'attachments', 'group_payment', 'tax.typeOfTax', 'approval.approval_flow', 'installments.bank_account_provider', 'installments.group_payment.form_payment', 'provider', 'bank_account_provider', 'business', 'cost_center', 'chart_of_accounts', 'currency', 'user'];
