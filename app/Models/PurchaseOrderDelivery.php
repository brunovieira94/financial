...
class PurchaseOrderDelivery extends Model
{
    ...
    protected $fillable = ['payment_request_id', 'purchase_order_id', 'product_id', 'service_id', 'delivery_quantity'];
    protected $hidden = ['payment_request_id', 'purchase_order_id', 'product_id', 'service_id'];
}
