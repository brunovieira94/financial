...
class PaymentRequestClean extends Model
{
    // Logs
    use LogsActivity;
    ...
    {
        return $this->hasOne(CnabGeneratedHasPaymentRequests::class, 'payment_request_id', 'id')->orderBy('id', 'asc'); //->with('cnab_generated')
    }
