...
class SupplyApprovalFlow extends Model
{
    ...
    {
        return $this->hasOne(PurchaseOrder::class, 'id', 'id_purchase_order')->with(['user','approval','cost_centers', 'attachments', 'services', 'products', 'companies', 'currency', 'provider', 'purchase_requests']);
    }
