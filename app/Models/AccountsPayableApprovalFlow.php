...
class AccountsPayableApprovalFlow extends Model
{
    ...
    {
        return $this->hasOne(PaymentRequest::class, 'id', 'payment_request_id')->with(['attachments', 'approval', 'installments', 'provider', 'bank_account_provider', 'business', 'cost_center', 'chart_of_accounts', 'currency', 'user', 'tax', 'group_payment'])->withTrashed();
    }
