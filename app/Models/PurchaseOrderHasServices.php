...
class PurchaseOrderHasServices extends Model
{
    ...
    protected $fillable = ['purchase_order_id', 'service_id', 'unitary_value', 'initial_date', 'end_date', 'automatic_renovation', 'notice_time_to_renew', 'percentage_discount', 'money_discount', 'frequency_of_installments', 'contract_duration'];
