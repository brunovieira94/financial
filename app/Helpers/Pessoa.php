...
class Pessoa implements PessoaContract
{
     ...
     * @return Pessoa
     */
    public static function create($nome, $documento, $endereco = null, $bairro = null, $cep = null, $cidade = null, $uf = null, $numero = null, $complemento = null)
    {
        return new static([
            'nome' => $nome,
            'endereco' => $endereco,
    ...
    {
        $dados = array_filter(array($this->getEndereco(), $this->getNumero(), $this->getBairro(), $this->getCidade(), $this->getUf(), $this->getCep()));
        return implode(' - ', $dados);
    }
