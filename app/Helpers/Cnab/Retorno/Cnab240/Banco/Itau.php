...
namespace App\Helpers\Cnab\Retorno\Cnab240\Banco;

use App\Helpers\Cnab\Retorno\Cnab240\AbstractRetorno;
use App\Helpers\Contracts\Boleto\Boleto as BoletoContract;
use App\Helpers\Contracts\Cnab\RetornoCnab240;
...
class Itau extends AbstractRetorno implements RetornoCnab240
{
    ...
    private $ocorrencias = [
        ...
        'BE' => 'PAGAMENTOAGENDADOCOMFORMAALTERADAPARAOP',
        ...
        'E1' => 'VALOR 1 DO HOLERITE / INFORME INVÁLIDO',
        'E2' => 'VALOR 2 DO HOLERITE / INFORME INVÁLIDO',
        'E3' => 'VALOR 3 DO HOLERITE / INFORME INVÁLIDO',
        'E4' => 'VALOR 4 DO HOLERITE / INFORME INVÁLIDO',
        ...
        'PD' => 'AQUISIÇÃO CONFIRMADA (EQUIVALE A OCORRÊNCIA 2 NO LAYOUT DE RISCO SACADO)',
        ...
        'X1' => 'FORMA INCOMPATÍVEL COM LAYOUT 10',
    ...
    protected function processarHeaderLote(array $headerLote)
    {
        $this->getHeaderLote()
            ...
            //->setNumeroRetorno($this->rem(111))
            //->setDataGravacao($this->rem(24112021))
            //->setDataCredito($this->rem(24112021));
        return true;
    }
    ...
    protected function processarDetalhe(array $detalhe)
    {
        ...
        }elseif ($this->getSegmentType($detalhe) == 'T') {
            ...
            */
            ...
            if ($d->hasOcorrencia('06', '08', '10')) {
                ...
                if(array_search('a4', array_map('strtolower', $msgAdicional)) !== false) {
                    //$d->getPagador()->setDda(true); error
                }
